...
<div class="row mx-5 mt-5">
    <div class="col">
        <small class="text-muted">Terdapat <span class="text-success font-weight-bold">{{ $programtype->programs()->count() }}</span> pilihan program untuk :</small>
        <h1>{{ $title }}</h1>
        <hr>
    </div>
</div>

@foreach($programtype->programs as $prog)
